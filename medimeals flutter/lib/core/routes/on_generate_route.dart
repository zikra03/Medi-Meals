...
import '../../views/auth/rec_form.dart';
import '../../views/auth/rec_form1.dart';
import '../../views/auth/rec_form2.dart';
import '../../views/auth/rec_form3.dart';
import '../../views/auth/rec_form4.dart';
...
class RouteGenerator {
  static Route? onGenerate(RouteSettings settings) {
    ...
    switch (route) {
      ...
      case AppRoutes.rec_form:
        return CupertinoPageRoute(builder: (_) => const Form10());
      case AppRoutes.rec_form1:
        return CupertinoPageRoute(builder: (_) => const Form11());
      case AppRoutes.rec_form2:
        return CupertinoPageRoute(builder: (_) => const Form12());
      case AppRoutes.rec_form3:
        return CupertinoPageRoute(builder: (_) => const Form13());
      case AppRoutes.rec_form4:
        return CupertinoPageRoute(builder: (_) => const Form14());
